...
def parse_args():
    ...
    # model
    parser.add_argument('--model', default='vn_pointnet_am',
                        choices=['dgcnn',
                                 'vn_dgcnn',
    ...
    parser.add_argument('--checkpoint_dir', default="/home/hanbing/paper_code/vnn/log/registr/vn_pointnet_am/so3_so3/2025-07-14_09-59")
    ...
    # Dataset
    parser.add_argument('--data_choice', default='shapenetcore',
                        choices=['shapenet', 'shapenetcore', 'modelnet', 'scanobject', 'threedmatch','modelnet_40cate'])
...
def test(testDataLoader, pose_model, logger, args):
    ...
    headers = ['Category', 'RRE_ang', 'RR5', 'RR10']
    row = [args.category,RRE_ang,  100 * RR5,  100 * RR10]
