...
class ShapeNetCoreH5Loader(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        pc_so3_1, R_so3_1 = rotate_point_cloud(point_cloud[:, 0:3])  # so3
        pc_so3_2, R_so3_2 = rotate_point_cloud(point_cloud[:, 0:3])  # so3
        pc_so3_3, R_so3_3 = rotate_point_cloud(point_cloud[:, 0:3])  # so3
