...
class VN_Transformer_noequ_linearx1lR(nn.Module):
    def __init__(self,
                 dim,
                 num_heads=64,
                 in_features=1,
        ...
        self.vnn_lin_1 = VNSimpleLinear(self.feat_dim, self.feat_dim)  # 就是VNLinear
        self.complex_lin_1 = Nonequ_Module_lR(self.feat_dim, self.feat_dim, args=None)
    ...
    def forward(self, x):
        ...
        # first
        x = x.unsqueeze(3)  # [batch, dim * 2, 3, 1]
        v = self.vnn_lin_1(x).permute(0, 3, 1, 2)
...
class VN_Transformer_noequ_linearx1lRlR(nn.Module):
    def __init__(self,
                 dim,
                 num_heads=64,
                 in_features=1,
        ...
        self.vnn_lin_1 = VNSimpleLinear(self.feat_dim, self.feat_dim)  # 就是VNLinear
        self.complex_lin_1 = Nonequ_Module_lRlR(self.feat_dim, self.feat_dim, args=None)
...
class VN_Transformer_noequ_linearx1lRlRlR(nn.Module):
    def __init__(self,
                 dim,
                 num_heads=64,
                 in_features=1,
        ...
        self.vnn_lin_1 = VNSimpleLinear(self.feat_dim, self.feat_dim)  # 就是VNLinear
        self.complex_lin_1 = Nonequ_Module_lRlRlR(self.feat_dim, self.feat_dim, args=None)
...
class VN_Transformer_NZT_W_lR(nn.Module):
    # Described in Figure 2
    def __init__(self,
                 dim,
                 num_heads=64,
        ...
        self.vnn_lin_2 = VNSimpleLinear(self.feat_dim, self.feat_dim)
        self.vnn_lin_2_ = VNSimpleLinear(self.feat_dim, self.feat_dim)
        self.complex_lin_1 = Module_nzt_W_lR(self.feat_dim, self.feat_dim, args=None)
...
class VN_Transformer_NZT_W_lRlR(nn.Module):
    # Described in Figure 2
    def __init__(self,
                 dim,
                 num_heads=64,
        ...
        self.vnn_lin_2 = VNSimpleLinear(self.feat_dim, self.feat_dim)
        self.vnn_lin_2_ = VNSimpleLinear(self.feat_dim, self.feat_dim)
        self.complex_lin_1 = Module_nzt_W_lRlR(self.feat_dim, self.feat_dim, args=None)
