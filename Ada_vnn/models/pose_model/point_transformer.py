...
from models.utils.pointnet_util2 import PointNetFeaturePropagation, PointNetSetAbstraction
from models.pose_model.transformer import TransformerBlock
...
class Backbone(nn.Module):
    def __init__(self, cfg):
        super().__init__()
        npoints, nblocks, nneighbor, d_points = cfg.num_point, 4, 16, 3
        transformer_dim = 512
        self.fc1 = nn.Sequential(
...
class PointTransformer(nn.Module):
    ...
    def forward(self, x):
        ...
        feature = points.mean(1)
        #res = self.fc2(feature)
